		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comangelprojectangel-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comangelprojectangel-display": {
								"semanticObject": "comangelprojectangel",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.angel.projectangel",
									"url": sap.ui.require.toUrl("com/angel/projectangel")
								}
							}
						}
					}
